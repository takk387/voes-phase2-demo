...
<div class="space-y-6">
  <div class="flex items-baseline justify-between">
    <div>
      <h1 class="text-2xl font-semibold">Skilled Trades TL dashboard</h1>
      <p class="text-sm text-ink-600 mt-0.5">
        Your ST area. Initiate a posting; the dedicated ST supervisor approves
        before the TM is notified.
      </p>
    </div>
  </div>
  ...
  {#each data.areas as area}
    <div class="card">
      <div class="card-header flex items-center justify-between">
        ...
        <a href="/skt-tl/post" class="btn-primary text-xs px-3 py-1.5">Post new ST opportunity</a>
      </div>
